...
import {deleteItem, getAllLocations, getLocationItems} from '../Context/Actions'
    ...
    const delItem = async (e, itemId) => {
      ...
      if (window.confirm('Are you sure you wish to delete this item?'))
      {
        ...
        if (typeof response === 'string' ) {
          ...
          const data = await getLocationItems(params.locationId)
          setItems(data);
          return notify()
      }
    }
        ...
        <div className="flex flex-row">
          ...
          <Menu.Items className="rounded-md shadow-lg bg-white divide-y divide-gray-300 focus:outline-none w-11/12">
            ...
            locations.map((location) => 
                <Menu.Item>
                <div onClick={(e) => changeLocation(e, location)}
                  className="ml-2 flex flex-row items-center justify-between">
                  {location.name}
